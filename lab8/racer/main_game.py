...
background = pygame.image.load(r"C:\Users\Farkhat\Desktop\PP2\labworks\lab8\racer\materials\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Farkhat\Desktop\PP2\labworks\lab8\racer\materials\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Farkhat\Desktop\PP2\labworks\lab8\racer\materials\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Farkhat\Desktop\PP2\labworks\lab8\racer\materials\coin.gif")
...
pygame.mixer_music.load(r"C:\Users\Farkhat\Desktop\PP2\labworks\lab8\racer\materials\background.wav")
...
while running:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        ...
        pygame.mixer.Sound(r"C:\Users\Farkhat\Desktop\PP2\labworks\lab8\racer\materials\crash.wav").play()
        time.sleep(0.5)
    ...
    if pygame.sprite.spritecollideany(P1, coins_sprite):
        pygame.mixer.Sound(r"C:\Users\Farkhat\Desktop\PP2\labworks\lab8\racer\materials\coin.mp3").play()
        COINS += 1
        C1.kill()
